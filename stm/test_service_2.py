...
class Parser_TestCase(unittest.TestCase):
    ...
    def test_008_parser_can_exponent(self):
        assert parse_service_call("14.123456789e-6") == 14.123456789e-6
        assert parse_service_call("6.5e-10") == 6.5e-10
        assert parse_service_call("2e10") == 2e10
        assert parse_service_call("87.3e+9") == 87.3e+9
        assert parse_service_call("e10") == 1e10
